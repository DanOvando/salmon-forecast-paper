...
Each of the machine learning methods had access to a variety of population and environmental data. We fit versions of each model separately for each age group in each major river system. Within that river system, the candidate predictor variables included the sibling returns for the cohort in question in all river systems, spawning abundance producing the cohort in question, along with the running mean environmental conditions (sea surface temperature, pacific decadal oscillation, sea surface air pressure, and degree of upwelling) over the years the cohort spent at sea, and the reported numbers of chum and pink salmon throughout the North Pacific reported by @ruggerone2018.
