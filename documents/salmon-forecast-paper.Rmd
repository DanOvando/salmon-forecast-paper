...
<!-- Beyond improving predictions, multi-model inference can help identify whether bottlenecks in forecast skill are due to model specification or data limitations.  -->
...
All data, code, and package dependencies needed to fully reproduce our results are publically available at www.github.com/danovando/salmon-forecast-paper. 
...
```{r, fig.cap="Best performing model in terms of scaled root mean squared error (SRMSE) for each age group and river system. Color indicates the percent improvement in SRMSE between the best performing model and the historic published Fisheries Research Institute (FRI) forecasts."}
