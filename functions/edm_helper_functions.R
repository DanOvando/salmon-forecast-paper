...
composite_predict_one <- function(pred_location, input, years = 2000:2018,
...
loop_preds <- function(year_vec = 2000:2018, systems = unique(dat$System),
...
predict_from_group <- function(groups, pred_col1, yr_vec = 2000:2018, ...){
# browser()
